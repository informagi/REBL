...
def test_create_error_file(tmp_path):
    in_file = path.dirname(path.dirname(__file__)) + f'/resources/utils/fake_error_ids.txt'
    out_file = str(tmp_path) + '/outfile.txt'
    source_folder = path.dirname(path.dirname(__file__)) + f'/resources/md/sample_docs_first_ten'
    expected_out_file = path.dirname(path.dirname(__file__)) + f'/resources/utils/fake_error_ids_as_source_file.txt'
